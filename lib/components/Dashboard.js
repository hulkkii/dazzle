...
// Component without DndProvider for cases where user wants to provide their own DndProvider
class DashboardWithoutDndContext extends Component {
  render() {
    return (
      <div>
        <LayoutRenderer {...this.props} />
...
DashboardWithoutDndContext.propTypes = Dashboard.propTypes;

export { DashboardWithoutDndContext };
